  ...
  gt(function () {
    return (
      e
        ...
        : ((v.current = new Mt({ limit: p, page: g })),
          t.pipeline.register(v.current)),
    ...
    return (
      ...
      (i.populatePlugins = function (t, n) {
        for (var r, o = s(n); !(r = o()).done; ) {
          var i = r.value;
          void 0 !== i.plugin &&
            t.add(e({ id: i.id }, i.plugin, { position: zt.Cell }));
        }
      }),
    ...
    return (
      ...
      (t.fromPartialConfig = function (n) {
        ...
        return (
          ...
          (e.plugin = new $t()),
          e.search &&
            e.plugin.add({ id: "search", position: zt.Header, component: Dt }),
          e.pagination &&
            e.plugin.add({
              id: "pagination",
              position: zt.Footer,
  ...
  return w(
    ...
    t.children
      ...
      : t.row.cells.map(function (n, r) {
          ...
          return o && o.hidden
            ? null
            : w(dn, { key: n.id, cell: n, row: t.row, column: o });
        })
  );
}
function _n(t) {
  ...
  gn = function (t, n, r) {
    return function (o) {
      ...
      return e(
        {},
        o,
        i ? yn(t, 1 === i.direction ? -1 : 1, n, r)(o) : yn(t, 1, n, r)(o)
      );
    };
  },
